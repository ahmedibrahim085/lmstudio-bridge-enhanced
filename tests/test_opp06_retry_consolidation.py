...
class TestRetryHierarchy:
    ...
    def test_retry_logic_exports_backoff_from_error_handling(self):
        ...
        assert retry_with_exponential_backoff is retry_with_backoff
    ...
    def test_retry_logic_circuit_breaker_class_exists(self):
        ...
        cb = LMSCircuitBreaker(failure_threshold=3, recovery_timeout=1)
        assert cb.state == "CLOSED"

    def test_retry_logic_circuit_breaker_open_error_exists(self):
        """CircuitBreakerOpenError still importable."""
        from utils.retry_logic import CircuitBreakerOpenError
    ...
    def test_circuit_breaker_state_transitions(self):
        ...
        from utils.retry_logic import CircuitBreakerOpenError, LMSCircuitBreaker

        cb = LMSCircuitBreaker(failure_threshold=3, recovery_timeout=0.1)
