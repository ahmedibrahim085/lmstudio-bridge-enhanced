...
def test_phase_2_3():
    ...
    for method in methods_requiring_decorator:
        total_tests += 1
        # Find method docstring and check for new exception types
        ...
        if match:
            ...
            has_new_exceptions = (
                "LLMTimeoutError" in docstring or
                "LLMConnectionError" in docstring or
                "LLMResponseError" in docstring or
                "LLMError" in docstring
            )
            ...
            print(f"❌ {method}: docstring not found")
            failed_tests.append(f"{method} docstring not found")
...
if __name__ == "__main__":
    import re  # Import here for the test
